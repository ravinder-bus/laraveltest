    ...
    <div class="row">
        <div class="col-md-5 col-sm-12 col-xs-12">
          <div class="product-image"> 
            <img src="{{ URL::to('/') }}/public/image/<?php echo $product['image']?>" class="img-responsive"> 
        ...
        <div class="product-info smart-form">
          <div class="row">
            <div class="col-md-12"> 
              <a href="javascript:void(0);" attr="<?php echo $product['id'];?>"  class="btn btn-danger product_id" >Add to cart</a>
                            <a href="/product-description/<?php echo $product['id']; ?>" class="btn btn-info">More info</a>
            </div>
    ...
    var cart=[];
        $(".product_id").click(function(){
            ...
            var cart_count=$('.cart-count').text();
               ...
               $.ajax({ 
                    url: '/add-to-cart',
                    data: {'items': cart, "_token": "{{ csrf_token() }}"},
                    type: 'post',
